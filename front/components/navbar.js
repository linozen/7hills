          ...
          <div className="mx-auto">
            <nav className={`px-4 py-5 ${onEvents ? 'bg-blue-dark' : 'bg-olive-500'}`}>
              <ul className="hidden lg:flex content-center justify-center items-center pb-6">
                ...
                <a className="ml-3 w-6 h-6 transition duration-700 transform hover:scale-150" href="https://instagram.com/sevenhills_restaurant" target="_blank">
                ...
                <a className="ml-4 mr-3 w-6 h-6 transition duration-700 transform hover:scale-150" href="https://www.facebook.com/SevenHillsRestaurantCGN/" target="_blank">
                  <button className="text-gold-500 pb-4">
